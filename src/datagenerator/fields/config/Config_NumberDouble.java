...
/**
 * This is the GUI class used to configure the NumberDoubleField Class.
 */
public class Config_NumberDouble extends javax.swing.JFrame implements java.awt.event.ActionListener{
    ...
    private javax.swing.JTextField jTextField2;//Minimum
    private javax.swing.JTextField jTextField3;//Maximum
    
    private datagenerator.fields.NumberDoubleField Tuple;
    
    /**
     * This is the default constructor for the class.
     * @param T This is a reference to the parent NumberDoubleField which this GUI is used to edit.
     */
    public Config_NumberDouble(datagenerator.fields.NumberDoubleField T){
    	Tuple = T;
    	initComponents();
    	jButton1.addActionListener(this);
    	this.setTitle("Number :: Double");
     ...
     */
    public Config_NumberDouble(datagenerator.fields.NumberDoubleField T, NumberDoubleCompressedField Comp){
    	Tuple = T;
    	initComponents();
    	jButton1.addActionListener(this);
    	setDefaultCloseOperation(javax.swing.WindowConstants.HIDE_ON_CLOSE);
    	this.jTextField1.setText(Comp.getName());
    	this.jTextField2.setText(new Double(Comp.getMinimum()).toString());
    	this.jTextField3.setText(new Double(Comp.getMaximum()).toString());
    }

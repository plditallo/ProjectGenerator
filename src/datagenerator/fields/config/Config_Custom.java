...
/**
 * This is the GUI class used to configure the CustomField Class.
 */
public class Config_Custom  extends javax.swing.JFrame implements java.awt.event.ActionListener {
	/**
	 * 
	 */
    ...
    private datagenerator.fields.CustomField Tuple;
    
    String File = null;
   
    /**
     * This is the default constructor for the class.
     * @param T This is a reference to the parent CustomField which this GUI is used to edit.
     */
    public Config_Custom(CustomField T){
    	Tuple = T;
    	initComponents();
    	jButton1.addActionListener(this);
    	jButton2.addActionListener(this);
    	this.setTitle("Custom Data");
     ...
     */
    public Config_Custom(CustomField T, CustomCompressedField Comp){
    	Tuple = T;
    	initComponents();
    	jButton1.addActionListener(this);
    	jButton2.addActionListener(this);

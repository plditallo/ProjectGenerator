 ...
 *
 */
public class CustomWieghtCompressedField implements CompressedField{
	 ...
	 */
	public CustomWieghtCompressedField(String Name, boolean activated, boolean unique, String FilePath){
		this.Name = Name;
	 ...
	 */
	public int getType() {
		return AddDialog.CustomWeighted;
	}
